...
$sql=mysqli_query($con,"SELECT password FROM user_form where password='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$userid=$_SESSION['id'];
$ret=mysqli_query($con,"update user_form set password='$newpassword' where id='$userid'");
...
<html lang="en">
    <head>
        ...
        <title>Change password | Registration and Login</title>
