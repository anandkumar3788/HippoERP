...
if($row>0) 
 {
    ...
    $msg=mysqli_query($conn,"insert into user_form(fname,lname,email,password,contact,user_role,date) values('$fname','$lname','$email','$password','$contact','$user_role','$date')");
     //echo "<pre>";
	// print_r($_POST);EXIT;
if($msg)
{	
